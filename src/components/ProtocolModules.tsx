...
const modules = [
  ...
  },
  {
    ...
    icon: Shield,
    features: ["$0.10 encrypted backups", "Recovery is ALWAYS free", "Secure encryption"],
  },
  {
    num: "03",
    step: "Transact",
    label: "Agentic Wallet",
    desc: "Absolute financial sovereignty. The agent generates endless value via the protocol, dynamically utilizing its funds for secure decentralised storage and unstoppable operations.",
    color: "bg-[var(--accent-crimson)]",
    textColor: "text-white",
    icon: Wallet,
    features: ["Session spending limits", "Machine payments", "Built-in compliance"],
  },
  {
    num: "04",
    step: "Comply",
